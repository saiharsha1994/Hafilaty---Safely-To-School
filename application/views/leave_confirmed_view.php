...
<h4>LEAVE DECISION CONFIRMED</h4>
</div>
...
<h5 style="margin-left:20px;text-align:center">copyright@VT</h5>
    ...
    <script type="text/javascript">
        function active(){$(".main-nav li").removeClass("active"),$("#leave2").addClass("active"),$("#leave").removeClass("sub-menu collapse"),$("#leave").addClass("sub-menu active")}function change_bus(a){$("#personDataTable").empty(),leave_data(a.value)}function leave_data(a){selected_bus_id=a,$.ajax({url:"<?php echo site_url('Welcome/confirmed_leave_data')?>",type:"POST",data:{param0:a},dataType:"JSON",success:function(a){"nodata"==a[0].response?alert("No Confirmed Leave Found!"):drawTable(a)},error:function(a,b,c){alert("Error get data from ajax")}})}function drawTable(a){for(var b=0;b<a.length;b++)drawRow(a[b])}function drawRow(a){var c=(a.id,$("<tr />"));$("#personDataTable").append(c),c.append($("<td class=col-sm-2>"+a.student_name+"</td>")),c.append($("<td class=col-sm-2>"+a.from_date+"</td>")),c.append($("<td class=col-sm-2>"+a.to_date+"</td>")),c.append($("<td class=col-sm-4>"+a.reason+"</td>")),2==a.status?c.append($("<td class=col-sm-2 style='color: green;'><h5>Approved</h5></td>")):3==a.status&&c.append($("<td class=col-sm-2 style='color: red;'><h5>Rejected</h5></td>"))}var selected_bus_id;$(document).ready(function(){appMaster.menuToggler(),appMaster.anotherFunction()});
    </script>
  </body>
</html>